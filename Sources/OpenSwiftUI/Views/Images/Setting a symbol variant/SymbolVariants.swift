...
public struct SymbolVariants : Hashable, Sendable {
    ...
    /// The flags of the symbol variants.
    let flags: SymbolVariants.Flags

    /// The shape of the symbol variants.
    let shape: SymbolVariants.Shape?

    // MARK: - Creating a Symbol Variants.

    /// Creates a new symbol variants with the given flags and shape.
    /// 
    /// - Parameters:
    ///   - flags: The flags of the symbol variants.
    ///   - shape: The shape of the symbol variants.
    init(flags: SymbolVariants.Flags, shape: SymbolVariants.Shape?) {
        self.flags = flags
        self.shape = shape
    }

    // MARK: - Getting Symbol Variants.
    ...
    public static let none = SymbolVariants(flags: .none, shape: nil)
    ...
    public static let circle = SymbolVariants(flags: .none, shape: .circle)
    ...
    public static let square = SymbolVariants(flags: .none, shape: .square)
    ...
    public static let rectangle = SymbolVariants(flags: .none, shape: .rectangle)
    ...
    public var circle: SymbolVariants { 
        .init(flags: self.flags, shape: .circle) 
    }
    ...
    public var square: SymbolVariants { 
        .init(flags: self.flags, shape: .square) 
    }
    ...
    public var rectangle: SymbolVariants { 
        .init(flags: self.flags, shape: .rectangle) 
    }
    ...
    public static let fill = SymbolVariants(flags: .fill, shape: nil)
    ...
    public var fill: SymbolVariants { 
        .init(flags: .fill, shape: self.shape) 
    }
    ...
    public static let slash = SymbolVariants(flags: .slash, shape: nil)
    ...
    public var slash: SymbolVariants { 
        .init(flags: .slash, shape: self.shape) 
    }
...
extension SymbolVariants {
    ...
    /// The flags of the symbol variants.
    enum Flags : Int, Codable, Equatable, Hashable, Sendable {

        /// The flag for the none variant.
        case none = 0

        /// The flag for the fill variant.
        case fill = 1

        /// The flag for the slash variant.
        case slash = 2
    }

    /// The shape of the symbol variants.
    enum Shape : String, Codable, Equatable, Hashable, Sendable {

        /// The shape for the circle variant.
        case circle

        /// The shape for the square variant.
        case square

        /// The shape for the rectangle variant.
        case rectangle
    }
}