...
/// 
/// This type acts like a proxy for the contents of the window defined by a SwiftUI Scene. 
...
public struct WindowLayoutRoot {
    ...
    /// 
    /// - Parameter proposal: A proposed size for the subview. In SwiftUI, views choose their own size, but can take a size proposal from their parent view into account when doing so.
